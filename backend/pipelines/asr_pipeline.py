"""Refactored ASR pipeline — no Gradio dependencies.

Extracted and adapted from ui/asr_tab._run_asr().
Replaces gr.Progress with a simple callback and gr.State with plain dict returns.
"""
...
def run_asr_pipeline(
    ...
    return {"text": si_text, "timestamps": timestamps}
